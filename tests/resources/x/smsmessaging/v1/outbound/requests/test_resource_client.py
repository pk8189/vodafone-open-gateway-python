...
from sms_messaging_interface.types.x.smsmessaging.v1.outbound.requests import models
...
def test_create_201_generated_success_default():
    ...
    client = Client()
    response = client.x.smsmessaging.v1.outbound.requests.create(
        customer_id="string",
...
async def test_await_create_201_generated_success_default():
    ...
    client = AsyncClient()
    response = await client.x.smsmessaging.v1.outbound.requests.create(
        customer_id="string",
        sender_address="string",
        data={
            "outbound_sms_message_request": {
