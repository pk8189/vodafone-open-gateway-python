...
from sms_messaging_interface.resources.smsmessaging.v1.outbound.requests.delivery_infos import (
    AsyncDeliveryInfosClient,
    DeliveryInfosClient,
)
from sms_messaging_interface.types.smsmessaging.v1.outbound.requests import (
    params,
    models,
)
import typing
    ...
    def create(
        ...
        *,
        ...
        return self._base_client.request(
            method="POST",
            path=f"/smsmessaging/v1/outbound/{sender_address}/requests",
            json=_json,
