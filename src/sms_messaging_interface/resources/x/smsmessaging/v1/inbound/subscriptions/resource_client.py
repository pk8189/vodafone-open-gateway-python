...
import typing
from sms_messaging_interface.types.x.smsmessaging.v1.inbound.subscriptions import (
    params,
    models,
)
...
class SubscriptionsClient:
    ...
    def create(
        ...
        *,
        ...
        return self._base_client.request(
            method="POST",
            path=f"/{customer_id}/smsmessaging/v1/inbound/subscriptions",
            json=_json,
    ...
    def delete(
        ...
        *,
        ...
        return self._base_client.request(
            method="DELETE",
            path=f"/{customer_id}/smsmessaging/v1/inbound/subscriptions/{subscription_id}",
            cast_to=type(None),
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)
