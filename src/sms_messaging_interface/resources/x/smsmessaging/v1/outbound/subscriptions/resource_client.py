...
class SubscriptionsClient:
    ...
    def create(
        ...
        *,
        ...
        return self._base_client.request(
            method="POST",
            path=f"/{customer_id}/smsmessaging/v1/outbound/{sender_address}/subscriptions",
            json=_json,
    ...
    def delete(
        ...
        *,
        ...
        return self._base_client.request(
            method="DELETE",
            path=f"/{customer_id}/smsmessaging/v1/outbound/{sender_address}/subscriptions/{subscription_id}",
            cast_to=type(None),
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)
